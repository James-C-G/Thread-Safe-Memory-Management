 ...
 *  Version :           1.4
 *  Description :       Part 2 header file that defines all the necessary structs and function names.
 *
 */

#ifndef COURSEWORK_2_PART2_H
#define COURSEWORK_2_PART2_H
